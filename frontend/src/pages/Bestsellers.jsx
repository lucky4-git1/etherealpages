        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <h1 className="text-4xl md:text-5xl font-bold text-text-primary mb-4 flex items-center gap-4">
                Bestsellers
            ...
            <div className="flex gap-4">
              ...
              <div className="bg-surface/50 backdrop-blur-md border border-cream-dark/50 p-6 rounded-2xl text-center min-w-[120px] shadow-sm">
                <div className="text-2xl font-bold text-text-primary">Top 10</div>
