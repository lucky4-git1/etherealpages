    ...
    <div className="pt-24 pb-12 min-h-screen">
      <div className="container mx-auto px-6">
        <header className="mb-12">
          <h1 className="text-4xl font-bold text-bronze-dark mb-2">My Wishlist</h1>
        ...
        {wishlist.length === 0 ? (
          ...
          >
            ...
            <h2 className="text-2xl font-bold text-bronze-dark mb-4">Your wishlist is empty</h2>
              ...
              >
                ...
                <div className="flex flex-col flex-grow">
                  <div className="flex justify-between items-start">
                    <h3 className="font-bold text-bronze-dark leading-tight mb-1">{book.title}</h3>
                  ...
                  <p className="text-lg font-bold text-bronze-dark mb-4">{formatINR(book.price)}</p>
