      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md relative z-10">
        <div className="bg-surface-card/90 backdrop-blur-xl border border-cream-dark/50 rounded-3xl p-8 shadow-2xl shadow-dusty-rose/5">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-bronze-dark tracking-tight mb-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            {!isLogin && (
              <div>
                <label className="block text-sm font-medium text-bronze mb-2">Full Name</label>
                <input 
                  type="text" 
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  className="w-full bg-surface border border-cream-dark rounded-xl px-4 py-3 text-bronze-dark placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-dusty-rose/50"
            ...
            <div>
              <label className="block text-sm font-medium text-bronze mb-2">Email Address</label>
              <input 
                type="email" 
                value={email}
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="block text-sm font-medium text-bronze">Password</label>
