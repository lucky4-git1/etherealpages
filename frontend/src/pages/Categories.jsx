...
const Categories = () => {
  ...
  return (
    <div className="pt-24 pb-12 min-h-screen container mx-auto px-6">
      ...
      >
        <h1 className="text-4xl lg:text-5xl font-bold text-text-primary mb-4">Browse by Category</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {CATEGORIES.map((cat, idx) => (
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-text-primary mb-2">{cat.name}</h3>
